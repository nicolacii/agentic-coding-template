...
name: init-project
user-invocable: true
description: Initialize project — interactive setup wizard. Use ONCE at the start of a new project to configure agents, tech stack, sub-agent roles, and project conventions. Generates AGENTS.md, agent definitions, and writes config to .claude/project-config.yml.
---
...
### 2. `AGENTS.md` (filled with answers)
