# AGENTS.md — Project Hub

> Хаб проекта (<200 строк). Агент читает это в начале каждой сессии.
> Навигация и ключевые факты — здесь; глубокий контент — в `RESEARCH.md` по ссылкам отсюда.
